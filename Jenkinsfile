        ...
        stage ('Deployments'){
            parallel{
                stage ('Deploy to Staging'){
                    steps {
                        bat "echo y | pscp -i C:/Users/Kharayat/Desktop/Jenkins/MyTomcatKey.ppk C:/Users/Kharayat/Desktop/Jenkins/webapp.war ec2-user@${params.tomcat_dev}:/var/lib/tomcat7/webapps"
                    }
                }
